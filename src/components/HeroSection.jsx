...
// import Resume from "dist\Nakul_Gharote_resume.pdf"
...
function HeroSection() {
  return (
    <div>
      ...
      {/* Hero Section */}
      <section className="w-full max-w-container-max mx-auto px-sm sm:px-md md:px-lg py-sm sm:py-md md:py-xl flex flex-col md:flex-row items-center gap-sm sm:gap-md md:gap-xl min-h-screen sm:min-h-[85vh] md:min-h-[80vh] fade-in-section is-visible">
        <div className="flex-1 flex flex-col gap-sm sm:gap-md md:gap-md text-center md:text-left w-full">
          <h1 className="font-display-lg-mobile text-display-lg-mobile sm:text-3xl md:font-display-lg md:text-display-lg text-on-surface leading-tight sm:leading-tight">
            Master <br />
            <TextType
              text={["Web Dev " , "Frontend" , "Backend" ,"Database" ,"LLMs"]}
              typingSpeed={75}
              pauseDuration={1500}
              showCursor
              cursorCharacter="_"
          ...
          <p className="font-body-sm sm:font-body-md md:font-body-lg text-body-sm sm:text-body-md md:text-body-lg text-on-surface-variant max-w-2xl mx-auto md:mx-0">
          ...
          <div className="flex flex-col sm:flex-row gap-xs sm:gap-sm md:gap-sm justify-center md:justify-start mt-xs sm:mt-sm md:mt-sm">
            <button className="bg-primary-container text-on-primary px-sm sm:px-md md:px-lg py-xs sm:py-sm md:py-sm rounded-lg font-headline-sm sm:font-headline-md md:font-headline-md text-headline-sm sm:text-headline-md md:text-headline-md shadow-premium hover:shadow-premium-hover transform hover:-translate-y-1 transition-all duration-300 w-full sm:w-auto">
              Contact
            </button>
            <a
              href="/Nakul_Gharote_resume.pdf"
              download 
              className="border border-outline text-on-surface px-sm sm:px-md md:px-lg py-xs sm:py-sm md:py-sm rounded-lg font-headline-sm sm:font-headline-md md:font-headline-md text-headline-sm sm:text-headline-md md:text-headline-md hover:bg-surface-card transition-colors duration-200 flex items-center justify-center gap-xs w-full sm:w-auto"
            >
        ...
        <div className="flex-1 w-full flex justify-center mt-sm md:mt-0">
          <ProfileCard
            name="Nakul Gharote"
            ...
            contactText="Connect"
            className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-[720px]"
          />
        </div>
      </section>
    </div>
