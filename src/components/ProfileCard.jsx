...
const DEFAULT_POSTER_TITLE = 'Nakul Gharote';
const DEFAULT_POSTER_SUBTITLE = 'Full Stack Developer';
...
const ProfileCardComponent = ({
  ...
  miniAvatarUrl,
  name = DEFAULT_POSTER_TITLE,
  title = DEFAULT_POSTER_SUBTITLE,
  handle = 'javicodes',
  contactText = 'Contact',
  showUserInfo = true,
  onContactClick
      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                'radial-gradient(circle at 50% 12%, rgba(90, 115, 255, 0.18), transparent 30%), linear-gradient(180deg, #10162d 0%, #141b34 45%, #0b1020 100%)',
          ...
          >
            ...
            >
              <div
                className="absolute inset-0 backface-hidden will-change-transform transition-transform duration-[120ms] ease-out"
                style={{
                  transform:
                    'translateX(calc((var(--pointer-from-left) - 0.5) * 18px)) translateY(calc((0.5 - var(--pointer-from-top)) * 12px)) translateZ(0)',
            ...
            >
              <div
                ...
                style={{ top: '2.6em', display: 'flex', gridArea: 'auto' }}
              >
                <h3
                  className="font-semibold m-0 tracking-[-0.03em]"
                  style={{
                    fontSize: 'clamp(2rem, 5.2vw, 4rem)',
                    lineHeight: 0.94,
                    backgroundImage: 'linear-gradient(to bottom, #f3f5ff, #aab6ff 78%, #6970b8)',
                ...
                <p
                  className="font-semibold whitespace-nowrap mx-auto w-min tracking-[-0.03em]"
                  style={{
                    position: 'relative',
                    top: '-6px',
                    fontSize: 'clamp(1rem, 2vw, 1.4rem)',
                    margin: '0 auto',
                    backgroundImage: 'linear-gradient(to bottom, #d8ddff, #8791d8)',
                    backgroundSize: '1em 1.5em',
                    WebkitTextFillColor: 'transparent',
                    backgroundClip: 'text',
                    WebkitBackgroundClip: 'text',
